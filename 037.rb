...
For Example:
  ...
  Last one:
  You are given the array {20,10,-80,10,10,15,35}. At index 0 the left side is {}, The right
  side is {10,-80,10,10,15,35}, They both are equal to 0 when added. (Empty arrays are equal
  to 0 in this problem) Index 0 is the place where the left side and right side are equal.

Note: Please remember that in most programming/scripting languages the index of an array starts at 0.

Input:
  An integer array of length 0 < arr < 1000. The numbers in the array can be any integer positive
  or negative.
