...
Remarks:
  ...
  2. a or b might be nil or null or None or nothing (except in C++, COBOL, Crystal, D,
...
def comp(array1, array2)
  return false if array1.nil? || array2.nil? || array1.size != array2.size || array1.sort.map { |e| e * e } != array2.sort
